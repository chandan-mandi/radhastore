...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product card rounded h-100">
      <div class="product-img text-center"><img class="product-image card-img-top img-fluid" src=${product.image}></img></div>
      <div class="card-body">
      <h3>${product.title}</h3>
